<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ServiceHoursTest.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="ServiceHoursTest" %>
